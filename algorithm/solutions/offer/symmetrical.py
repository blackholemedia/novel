...
class Solution(BinaryTree):
    ...
    def generate_copy(self, source_node=None, target_node=None):
        if source_node:
            if self.copytree._header:
                ...
                self.copytree._header = TreeNode(source_node.val)
                iter_node = self.copytree._header
                if source_node.left == None and source_node.right == None:
    ...
    def isSymmetrical(self,pRoot):
        mirror_tree = self.generate_copy(pRoot._header)
        self.Mirror(pRoot._header)
        #print(mirror_tree)
        return self.comp(mirror_tree._header,pRoot._header)
